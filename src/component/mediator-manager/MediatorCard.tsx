        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 md:p-6 hover:shadow-xl transition-all duration-300">
            ...
            <div className="bg-blue-50 rounded-lg p-3 mb-4">
                <div className="flex items-center space-x-2">
                    ...
                    <p className="text-sm font-medium text-blue-900 truncate">{mediator.email}</p>
                </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
                ...
                <div className="space-y-2">
                    <div className="flex items-center">
                        <span className="text-sm text-gray-900 px-1">Họ: </span>
                        <span className="text-sm font-medium text-gray-900">{mediator.lastName}</span>
                    </div>
                    <div className="flex items-center">
                        <span className="text-sm text-gray-900 px-1">Tên: </span>
                        <span className="text-sm font-medium text-gray-900">{mediator.firstName}</span>
                    </div>
                </div>
            </div>
            ...
            {(onEdit || onDelete) && (
                <div className="flex flex-wrap items-center gap-2 pt-4 mt-4 border-t border-gray-100">
                    ...
                    {onDelete && (
                        <button
                            onClick={() => {
                                if (window.confirm(`Bạn có chắc chắn muốn xóa hòa giải viên "${mediator.fullName}"?`)) {
